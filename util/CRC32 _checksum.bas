...
Dim As String file = "D:\spiele\ElderScrollsOnline\The Elder Scrolls Online EU\vo_de\esoaudiode0000.dat"
Dim As Integer f = FreeFile
Dim As Integer pread=0
Dim As UByte Ptr item
Dim As Integer max_size = (2^20)*100

Open file For Binary As #f
	Do
		Print "start with block: " & pread
		If item <> 0 Then DeAllocate item
		
		item = Allocate(max_size)
		pread = 0
		get #f,,*(item),max_size,pread
		Print "finish block load"
	...
	Loop Until Eof(f) Or pread>max_size
Close #f
